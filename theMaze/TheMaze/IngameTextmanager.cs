...
namespace TheMaze
{
    public class IngameTextmanager
    {
        ...
        public void CheckProgression(GameTime gameTime)
        {
            switch (currentStage)
            {
                case Textstage.Q:
                    ...
                    if (Utility.IsKeyPressed(Keys.Space) && GamePlayManager.currentLevel == GamePlayManager.Level.Level2)
                ...
                case Textstage.P:
                    ...
                    if (Utility.mouseState.LeftButton == ButtonState.Pressed)
                        currentStage = Textstage.Å;
                    break;
                case Textstage.Å:
                    text = "You can press a weapon slot between [2,3,4] and equip that weapon to it.";
                    if (Utility.player.playerPointLight.Enabled == true)
                    {
                ...
                case Textstage.D:
                    ...
                    if (Utility.player.collectibles.Count == 2)
                    {
                    ...
                    if (Utility.player.collectibles.Count == 2 && Utility.IsKeyPressed(Keys.Space) || Utility.IsKeyPressed(Keys.Enter))
                        currentStage = Textstage.F;
                    break;
                case Textstage.F:

                    if (Utility.player.collectibles.Count == 3)
                    {
                    ...
                    if (Utility.IsKeyPressed(Keys.Space) && Utility.player.collectibles.Count == 3)
                ...
                case Textstage.J:
                    ...
                    break;
                case Textstage.K:
                    if (Utility.player.collectibles.Count == 5)
                    {
                    ...
                    if (Utility.IsKeyPressed(Keys.Space) && (Utility.player.collectibles.Count == 5))
                        currentStage = Textstage.L;
                    break;
                case Textstage.L:
                    if (Utility.player.collectibles.Count == 6)
                    {
                        text = "What a tragedy...";
                    }
                    else
                    ...
                    if (Utility.IsKeyPressed(Keys.Space) && (Utility.player.collectibles.Count == 6))
                        currentStage = Textstage.Ö;
                    break;
                case Textstage.Ö:
                    if (Utility.player.collectibles.Count == 7)
                    {
                    ...
                    if (Utility.IsKeyPressed(Keys.Space) && (Utility.player.collectibles.Count == 7))
                ...
                case Textstage.Ä:
                    ...
                    break;
                case Textstage.Z:
                    if (Utility.player.collectibles.Count == 8)
                    {
                    ...
                    if (Utility.IsKeyPressed(Keys.Space) && Utility.player.collectibles.Count == 8)
                        currentStage = Textstage.X;
                    break;
                case Textstage.X:
                    if (Utility.player.collectibles.Count == 9)
                    {
        ...
        {
            spriteBatch.DrawString(TextureManager.TutorialFont, text, new Vector2(Utility.player.Position.X, Utility.player.Position.Y - 25), Color.White);
        }

        public static void DrawMovingTutorial(SpriteBatch spriteBatch)
        {
            spriteBatch.DrawString(TextureManager.TutorialFont, "Move with the 'W,A,S,D' buttons. Sprint with 'SHIFT'.", new Vector2(Utility.player.Position.X, Utility.player.Position.Y - 25), Color.White);
        }

        public static void DrawPickUpTutorial(SpriteBatch spriteBatch)
        {
            spriteBatch.DrawString(TextureManager.TutorialFont, "Press 'F' to pick up this item.", new Vector2(Utility.player.Position.X, Utility.player.Position.Y - 25), Color.White);
        }

        public static void DrawLampOn(SpriteBatch spriteBatch)
        {
            spriteBatch.DrawString(TextureManager.TutorialFont, "Turn on your lantern with 'Q'.", new Vector2(Utility.player.Position.X, Utility.player.Position.Y - 25), Color.White);
        }

        public static void DrawLampOff(SpriteBatch spriteBatch)
        {
            spriteBatch.DrawString(TextureManager.TutorialFont, "Turn off your lantern with 'E'.", new Vector2(Utility.player.Position.X, Utility.player.Position.Y - 25), Color.White);
        }

        public static void DrawProgress(SpriteBatch spriteBatch)
        {
            spriteBatch.DrawString(TextureManager.TutorialFont, "Press 'ENTER' to commit suicide.", new Vector2(Utility.player.Position.X, Utility.player.Position.Y - 25), Color.White);
        }

        public static void DrawReturn(SpriteBatch spriteBatch)
        {
            spriteBatch.DrawString(TextureManager.TutorialFont, "Go to the LIGHT.", new Vector2(Utility.player.Position.X, Utility.player.Position.Y - 25), Color.White);
        }
    }
}
