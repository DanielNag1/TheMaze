...
namespace TheMaze
{
    class Enemy : GameObject
    {
        ...
        {
            if (position.X > Player.oldPosition.X || position.X < Player.oldPosition.X || position.Y > Player.oldPosition.Y || position.Y < Player.oldPosition.Y)
            {
                moving = true;
                if (position.X > Player.oldPosition.X)
                {
                ...
                if (position.Y > Player.oldPosition.Y)
                {
                ...
                if (position.Y > Player.oldPosition.Y && position.X < Player.oldPosition.X)
                {
            ...
            //    moving = true;
            //}
            //else if (position.X < Player.oldPosition.X)
            //{
            //    Direction = new Vector2(1, 0);
            ...
            //    moving = true;
            //}
            //else if (position.Y > Player.oldPosition.Y)
            //{
            //    Direction = new Vector2(0, -1);
